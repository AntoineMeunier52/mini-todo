...
<template>
  <div class="w-full">
    <div
      class="w-full flex flex-row mt-4 mb-1 border rounded-[5px] p-1 shadow-xl"
    >
      <input
        ref="inputRef"
        v-model="todoValue"
    ...
    <div
      class="w-full flex flex-row flex-wrap text-nowrap items-center justify-around text-gray-600 mb-5"
    >
      <p
        :class="[
          'transition-all',
